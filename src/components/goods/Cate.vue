<template>
    <div>
        ...
        <el-card>
            ...
            <!-- 表格区域 -->
            <tree-table show-index border :expand-type="false" :data="catelist" :columns="columns" :selection-type="false">
                <!-- 是否有效 -->
            ...
            <!-- 添加分类的对话框 -->
            <el-dialog
            title="添加分类" :visible.sync="addCateDialogVisible"
...
export default {
  ...
  methods: {
    ...
    // 选择项发生变化触发这个函数
    parentCateChanged () {
      // 如果selectedKeys数组中的id的长度大于0 则表示选中了父级分类
      // 反之，就说明没有选中
